...
from BundID_ZBP_SeleniumFramework.Classes.Attachments.LoadAttachmentAndReturnAttachmentAndMimeType import \
    AnhangVerwalter
...
########################################################################################################################
    ...
    title = f" [SOGETI] Rest mit 2 Anhaengen: {anhang_1}-{anhang_2}"
    text_content = title
...
# Generierung der msg-signatur und der signatur.b64Erstellung eines Tokens #############################################
    ...
    shasum_anhang_1,\
        ...
        = curl_12_generate_msg_signature.\
        create_printf_command_send_msg_with_2_attachment_return_shasum_and_content_lenght_from_attachement(
        anhang_1=anhang_1,
        anhang_2=anhang_2,
...
# Erstellung und senden des Curl commands ##############################################################################
    ...
    curl_14_generate_and_send_curl_request.create_curl_command_send_msg_2_attachments(
        anhang_1=anhang_1,
        anhang_2=anhang_2,
        anhang_pfad=anhang_pfad,
